package com.hexaware.hibernate2.entity;
...
@NamedQueries(
		{
			@NamedQuery(name="selectPaymentsByPayment_Type" , query="Select p from Payment p where p.payment_Type = :type "),
			@NamedQuery(name="selectAllPayments" , query = "select p from Payment p"),
